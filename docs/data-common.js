...
const UI_STRINGS = {
  pt: {
    ...
    trackWord: "faixa",
    tracksWord: "faixas",
    footer: "Site pessoal de fã — sem afiliação com Rhapsody of Fire. Letras completas disponíveis via link externo (Letras.com); o texto usa referências externas, e as imagens foram geradas por IA com base em prompts criados por mim.",
    aboutBtn: "Sobre",
    ...
    creditsBtn: "Créditos",
    creditsTitle: "Créditos das artes originais",
    creditsIntro: "As capas oficiais dos álbuns usadas neste site pertencem aos seus respectivos artistas — nenhuma delas foi gerada por IA. Os créditos abaixo vêm de fichas técnicas públicas (Metal Archives / Discogs).",
    creditsSourceLink: "Ver fonte ↗",
    creditsMapsNote: "Os dois mapas do site (Terras Encantadas e Known World) reproduzem mapas pintados dos encartes originais dos álbuns; não consegui confirmar o artista responsável por eles em nenhuma fonte pública — se você souber quem foi, me avisa!",
    creditsAiNote: "Todo o resto da arte do site (ilustrações da História Completa e do Codex) foi gerada por IA a partir de prompts meus, sem relação com os artistas listados acima."
  },
  en: {
    ...
    trackWord: "track",
    tracksWord: "tracks",
    footer: "Personal fan site — not affiliated with Rhapsody of Fire. Full lyrics available via external link (Letras.com); the text draws on external references, and the artwork was generated by AI based on prompts I wrote.",
    aboutBtn: "About",
    ...
    creditsBtn: "Credits",
    creditsTitle: "Original artwork credits",
    creditsIntro: "The official album covers used on this site belong to their respective artists — none of them were AI-generated. Credits below come from public release credits (Metal Archives / Discogs).",
    creditsSourceLink: "View source ↗",
    creditsMapsNote: "The site's two maps (Enchanted Lands and Known World) reproduce painted maps from the albums' original booklets; I couldn't confirm who illustrated them from any public source — if you know, please let me know!",
    creditsAiNote: "Every other piece of art on the site (Full Story chapter and Codex illustrations) was generated by AI from my own prompts, unrelated to the artists listed above."
  }
};

// Créditos das capas oficiais dos álbuns (arte real, não gerada por IA) — levantados a partir de
// fichas técnicas públicas (Metal Archives / Discogs) em ago/2026. Ver report.md para a pesquisa completa.
const ART_CREDITS = [
  { artist: "Eric Philippe", albums: ["Legendary Tales", "Symphony of Enchanted Lands"], url: "https://www.metal-archives.com/artists/Eric_Philippe/46977" },
  { artist: "Marc Klinnert (Studio Oxmox)", albums: ["Dawn of Victory", "Rain of a Thousand Flames", "Power of the Dragonflame", "Symphony of Enchanted Lands II – The Dark Secret"], url: "https://www.metal-archives.com/albums/Rhapsody_of_Fire/Dawn_of_Victory/110" },
  { artist: "Jeff Easley", albums: ["Triumph or Agony"], url: "https://www.metal-archives.com/albums/Rhapsody_of_Fire/Triumph_or_Agony/1227831" },
  { artist: "Felipe Machado Franco", albums: ["The Frozen Tears of Angels", "The Cold Embrace of Fear", "From Chaos to Eternity"], url: "https://www.metal-archives.com/albums/Rhapsody_of_Fire/From_Chaos_to_Eternity/1123429" }
];
...
// Coordenadas recalibradas a partir de leitura visual direta dos dois mapas oficiais (rodada de
// ago/2026): cada marcador é posicionado ao LADO do nome já impresso/pintado no mapa (não sobre o
// ícone da cidade), porque o marcador em si não exibe o nome — só um ponto e o contador de faixas —
// então a pessoa lê o rótulo do mapa e clica o botão logo ao lado. Ver report.md, Passo 5.
const LOCATIONS = [
  { id: "nordic_plains", nome: "Nordic Plains", pos: { enchanted: { x: 53, y: 16.5 }, known_world: { x: 46.5, y: 32 } } },
  { id: "sea_of_trolls", nome: "Sea of Trolls", pos: { enchanted: { x: 26.5, y: 21.8 }, known_world: { x: 32, y: 39 } } },
  { id: "elves_hills", nome: "The Elves Hills", pos: { enchanted: { x: 79.5, y: 25.8 }, known_world: { x: 39, y: 47 } } },
  { id: "forest_of_trolls", nome: "Forest of Trolls", pos: { enchanted: { x: 65, y: 26.5 }, known_world: { x: 44.5, y: 46.6 } } },
  { id: "caltor", nome: "Caltor", pos: { enchanted: { x: 16.5, y: 34 }, known_world: { x: 31, y: 43 } } },
  { id: "dragonland", nome: "Dragonland", pos: { enchanted: { x: 57, y: 32 }, known_world: { x: 49.5, y: 50 } } },
  { id: "ancelot", nome: "Ancelot", pos: { enchanted: { x: 49, y: 39.6 }, known_world: { x: 48, y: 54 } } },
  { id: "hargor", nome: "Hargor", pos: { enchanted: { x: 21.5, y: 39.6 }, known_world: { x: 37, y: 52.3 } } },
  { id: "darklands", nome: "Darklands", pos: { enchanted: { x: 37.5, y: 37 }, known_world: { x: 33, y: 51 } } },
  { id: "dar_kunor", nome: "Dar-Kunor", pos: { enchanted: { x: 27, y: 41 }, known_world: { x: 39.2, y: 52 } } },
  { id: "forest_of_unicorns", nome: "Forest of Unicorns", pos: { enchanted: { x: 39, y: 42.8 }, known_world: { x: 43, y: 48 } } },
  { id: "grey_mountains", nome: "Grey Mountains", pos: { enchanted: { x: 16, y: 43 }, known_world: { x: 32, y: 53.5 } } },
  { id: "elgard", nome: "Elgard", pos: { enchanted: { x: 53, y: 48.8 }, known_world: { x: 48.5, y: 54.7 } } },
  { id: "kanor", nome: "Kanor", pos: { enchanted: { x: 95.0, y: 44.2 }, known_world: { x: 59.5, y: 52.5 } } },
  { id: "green_valleys", nome: "Green Valleys", pos: { enchanted: { x: 37.5, y: 52.5 }, known_world: { x: 42, y: 43 } } },
  { id: "lands_of_chaos", nome: "Lands of Chaos", pos: { enchanted: { x: 68, y: 54.3 }, known_world: { x: 53, y: 53.5 } } },
  { id: "desert_of_varg", nome: "Desert of Varg", pos: { enchanted: { x: 82.5, y: 51.5 }, known_world: { x: 55, y: 52 } } },
  { id: "enchanted_valleys", nome: "Enchanted Valleys", pos: { enchanted: { x: 13.5, y: 56.3 }, known_world: { x: 37, y: 53 } } },
  { id: "algalord", nome: "Algalord", pos: { enchanted: { x: 35.5, y: 62.6 }, known_world: { x: 49.5, y: 55.5 } } },
  { id: "hills_of_loregard", nome: "Hills of Loregard", pos: { enchanted: { x: 94, y: 56 }, known_world: { x: 58, y: 53 } } },
  { id: "loregard", nome: "Loregard", pos: { enchanted: { x: 83.5, y: 64 }, known_world: { x: 56, y: 54.8 } } },
  { id: "elnor", nome: "Elnor", pos: { enchanted: { x: 9.5, y: 68.2 }, known_world: { x: 42.5, y: 55 } } },
  { id: "irengard", nome: "Irengard", pos: { enchanted: { x: 63.5, y: 71 }, known_world: { x: 51, y: 56.2 } } },
  { id: "holy_lakes", nome: "Holy Lakes", pos: { enchanted: { x: 91, y: 72 }, known_world: { x: 58, y: 57 } } },
  { id: "thorald", nome: "Thorald", pos: { enchanted: { x: 14.5, y: 75 }, known_world: { x: 44, y: 55.6 } } },
  { id: "ragatorn", nome: "Ragatorn", pos: { enchanted: { x: 75.5, y: 84.5 }, known_world: { x: 53.5, y: 57 } } },
  ...
  // "Urien" tem rótulo próprio no mapa do Known World (distinto de "Urienor", mais a noroeste, que
  // não tem faixa vinculada e por isso não entrou como local à parte — ver Parte D3 do report.md).
  { id: "urien", nome: "Urien", pos: { enchanted: { x: 34.83, y: 23.1 }, known_world: { x: 43.5, y: 51.5 } } },
